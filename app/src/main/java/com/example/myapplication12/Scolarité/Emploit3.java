...
public class Emploit3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scolarete1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in = new Intent(Emploit3.this, Listcours.class);
                startActivity(in);
            }
        });
        messages1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(Emploit3.this, Listmessage.class);
                startActivity(in);
            }
        });
        evenement1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(Emploit3.this, Listevent.class);
                startActivity(in);
            }
        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.item5:
                Intent in5 = new Intent(Emploit3.this, AddEmploit3.class);
                startActivity(in5);
                break;
            case R.id.item88:
                Intent in11 = new Intent(Emploit3.this, Menuetudiant.class);
                startActivity(in11);
                break;

            case R.id.item10:
            Intent in10 = new Intent(Emploit3.this, Login.class);
            startActivity(in10);
            break;
        }
